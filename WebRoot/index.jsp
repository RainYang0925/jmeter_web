...
<body bgcolor="#C0C0C0">
	<div>
		<h1 align="center" style="color:#93F">WEB测试平台</h1>
	</div>
	<div>
		<hr color="#9933FF" />
	</div>
	<div style="float:left;">
		<select name="template" id="test">
			<option value="http" selected="selected">HTTP</option>
			<option value="jdbc">JDBC</option>
		</select>
		<div align="left">
			<button type="button" onclick="displaytemplate()">确定</button>
		</div>
		<div align="left">
			<p id=p1></p>
		</div>
		<div align="left">
			<form action="${pageContext.request.contextPath }/uploadServlet" method="post"
				...
				<label for="file">上传文件：</label><br> <input type="file" name="file" id="file"><br> 
	...
	<div
		style="float:left;position:relative;  height:2000px; overflow-y:auto; display:none"
		id="d3">
		<form action="${pageContext.request.contextPath }/createJmxServlet" method="post"
			style="position:relative;  height:2000px; overflow-y:auto">
			<div align="left">
				<b>线程组</b>
			</div>
...
function displaytemplate(){
    ...
    document.getElementById("p1").innerHTML="你选择了"+myselect.options[index].text+"模板";
